...
fun sampleSkillNodes(): List<SkillNode> = listOf(
    ...
    SkillNode("Design-Patterns","Design-Patterns",0,5, listOf(
        ...
        SkillConnection("Observer-Pattern", Direction.DDR),
    ...
    SkillNode("Dependency-Injection2","DI",0,5, listOf(
        SkillConnection("Dagger", Direction.UUR),
        SkillConnection("Hilt", Direction.UR),
        SkillConnection("Koin", Direction.RIGHT),
        SkillConnection("Kodein", Direction.DR),
    )),
    SkillNode("Observer-Pattern","Observer-Pattern",0,5, listOf(
        SkillConnection("Flow", Direction.UP),
        SkillConnection("Rxjava", Direction.RIGHT),
        SkillConnection("RxKotlin", Direction.DR),
        SkillConnection("LiveData2", Direction.DOWN),
    )),
    SkillNode("Architecture","Architecture",0,5, listOf(
        SkillConnection("MVVM", Direction.UP),
        SkillConnection("MVP", Direction.UL),
        SkillConnection("MVI", Direction.LEFT),
        SkillConnection("MVC", Direction.DL),
        SkillConnection("CleanArchitecture", Direction.DOWN),
    )),

    SkillNode("Dagger","Dagger",0,5, listOf()),
    SkillNode("Hilt","Hilt",0,5, listOf()),
    SkillNode("Koin","Koin",0,5, listOf()),
    SkillNode("Kodein","Kodein",0,5, listOf()),
    SkillNode("Flow","Flow",0,5, listOf()),
    SkillNode("Rxjava","Rxjava",0,5, listOf()),
    SkillNode("RxKotlin","RxKotlin",0,5, listOf()),
    SkillNode("LiveData2","LiveData",0,5, listOf()),
    SkillNode("MVVM","MVVM",0,5, listOf()),
    SkillNode("MVP","MVP",0,5, listOf()),
    SkillNode("MVI","MVI",0,5, listOf()),
    SkillNode("MVC","MVC",0,5, listOf()),
    SkillNode("CleanArchitecture","CleanArchitecture",0,5, listOf()),
